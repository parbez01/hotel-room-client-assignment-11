    ...
    return (
        <div>
            ...
            <div>
                ...
                <h2 className="text-5xl text-center font-bold  mt-12">Contact Us</h2>



                <div className="container my-10 mx-auto md:px-6" data-aos="zoom-in" data-aos-duration="2000">
                            ...
                            <div
                                ...
                                <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                                    <div className="mx-auto mb-12 text-center lg:mb-0">
                                        ...
                                        <h6 className="font-medium">Dhaka Mirpur</h6>
                                    </div>
                                    <div className="mx-auto mb-12 text-center lg:mb-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" className="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
                                        ...
                                        <h6 className="font-medium">Bangladesh, 94126</h6>
                                    </div>
